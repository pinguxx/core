...
var pep = __commonjs(function (module, exports, global) {
  /*!
   * PEP v0.4.1 | https://github.com/jquery/PEP
   * Copyright jQuery Foundation and other contributors | http://jquery.org/license
   */
  (function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof$1(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.PointerEventsPolyfill = factory();
...
var Accessors = function () {
    function Accessors(xtag) {
        _classCallCheck$2(this, Accessors);
    ...
    _createClass$2(Accessors, [{
        key: 'modAttr',
        value: function modAttr(element, attr, name, value, method) {
            this.attrProto[method].call(element, name, attr && attr.boolean ? '' : value);
        }
    }, {
        key: 'syncAttr',
        value: function syncAttr(element, attr, name, value, method) {
            if (attr && (attr.property || attr.selector)) {
                var nodes = attr.property ? [element.xtag[attr.property]] : attr.selector ? this.xtag.dom.query(element, attr.selector) : [],
                    index = nodes.length;
                while (index--) {
        ...
        key: 'attachProperties',
        value: function attachProperties(tag, prop, z, accessor, attr, name) {
            var key = z.split(':'),
                type = key[0],
                acc = this,
        ...
        key: 'parseAccessor',
        value: function parseAccessor(tag, prop) {
...
var mSelector = Element.prototype.matches || Element.prototype.matchesSelector || Element.prototype[prefix.lowercase + 'MatchesSelector'];
...
var Dom = function () {
    ...
    _createClass$3(Dom, [{
        key: 'parseMultiline',
        value: function parseMultiline(fn) {
        ...
        */
        ...
        key: 'query',
        value: function query(element, selector) {
            return (selector || '').length ? this.xtag.utils.toArray(element.querySelectorAll(selector)) : [];
        }
    }, {
        key: 'skipTransition',
        value: function skipTransition(element, fn, bind) {
            var prop = this.prefix.js + 'TransitionProperty',
                callback = fn ? fn.call(bind || element) : null;
            element.style[prop] = element.style.transitionProperty = 'none';
            return this.skipFrame(function () {
        ...
        value: function requestFrame() {
            var raf = this.win.requestAnimationFrame || this.win[this.prefix.lowercase + 'RequestAnimationFrame'] || function (fn) {
                return this.win.setTimeout(fn, 20);
            };
            return function (fn) {
                return raf(fn);
            };
        ...
        value: function cancelFrame() {
            var cancel = this.win.cancelAnimationFrame || this.win[this.prefix.lowercase + 'CancelAnimationFrame'] || this.win.clearTimeout;
            return function (id) {
                return cancel(id);
            };
        }
        ...
        key: 'skipFrame',
        value: function skipFrame(fn) {
            var _this = this;

            var id = this.requestFrame(function () {
                id = _this.requestFrame(fn);
            });
            return id;
        }
    }, {
        key: 'set',
        value: function set(element, method, value) {
        ...
        key: 'innerHTML',
        value: function innerHTML(el, html) {
        ...
        */
        ...
        key: 'createFragment',
        value: function createFragment(content) {
        ...
        */
        ...
        key: 'manipulate',
        value: function manipulate(element, fn) {
...
var Events = function () {
    function Events(xtag) {
        _classCallCheck$4(this, Events);
        ...
        this.customEvents = {
            ...
            taphold: {
                ...
                condition: function condition(event, custom) {
                    if (event.type == 'pointerdown') {
                        (custom.pointers = custom.pointers || {})[event.pointerId] = setTimeout(this.fireEvent.bind(null, this, 'taphold'), custom.duration || 1000);
    ...
    _createClass$4(Events, [{
        key: 'inheritEvent',
        value: function inheritEvent(event, base) {
        ...
        key: 'delegateAction',
        value: function delegateAction(pseudo, event) {
            var match,
                target = event.target,
        ...
        key: 'touchFilter',
        value: function touchFilter(event) {
            return event.button === 0;
        }
    }, {
        key: 'writeProperty',
        value: function writeProperty(key, event, base, desc) {
        ...
        key: 'parseEvent',
        value: function parseEvent(type, fn) {
            var _this = this;
            ...
            event.attach.forEach(function (name) {
                event._attach.push(_this.parseEvent(name, event.listener));
            });
            return event;
        }
    }, {
        key: 'addEvent',
        value: function addEvent(element, type, fn, capture) {
            var _this2 = this;
            ...
            event._attach.forEach(function (obj) {
                _this2.addEvent(element, obj.type, obj);
            });
        ...
        key: 'addEvents',
        value: function addEvents(element, obj) {
            var events = {};
            for (var z in obj) {
        ...
        key: 'removeEvent',
        value: function removeEvent(element, type, event) {
            var _this3 = this;
        ...
        key: 'removeEvents',
        value: function removeEvents(element, obj) {
            for (var z in obj) {
                this.removeEvent(element, obj[z]);
            }
        }
    }, {
        key: 'fireEvent',
        value: function fireEvent(element, type, options) {
...
var Mixins = function () {
    function Mixins(xtag) {
        _classCallCheck$5(this, Mixins);

        this.xtag = xtag;
        this.uniqueMixinCount = 0;
    }

    _createClass$5(Mixins, [{
        key: 'mergeMixin',
        value: function mergeMixin(tag, original, mixin) {
            var key = void 0,
                z = void 0;
            var keys = {};
            for (z in original) {
        ...
        key: 'resolveMixins',
        value: function resolveMixins(mixins, output) {
                    ...
                    if (!original) {
                        ...
                        switch (type) {
                            case 'mixins':
                                break;
                            case 'events':
                                _this.addMixin(tag, original, item);break;
                            case 'accessors':
                            case 'prototype':
                                for (var z in item) {
                                    if (!original[z]) {
                                        ...
                                        _this.mergeMixin(tag, original[z], item[z], name);
                                    }
                                }
                                break;
                            default:
                                _this.mergeMixin(tag, original, item, name);
                        }
                    }
                }
            });
...
var Pseudos = function () {
    function Pseudos(xtag) {
        _classCallCheck$6(this, Pseudos);
    ...
    _createClass$6(Pseudos, [{
        key: 'parsePseudo',
        value: function parsePseudo(fn) {
            fn();
        }
    }, {
        key: 'applyPseudos',
        value: function applyPseudos(key, fn, target, source) {
            var _this = this;
            ...
            if (key.match(':')) {
                ...
                while (i--) {
                    this.parsePseudo(function () {
                        ...
                        pseudo.action = pseudo.action || _this.xtag.utils.trueop;
                        pseudo.source = source;
                        pseudo.onAdd = pseudo.onAdd || _this.xtag.utils.noop;
                        pseudo.onRemove = pseudo.onRemove || _this.xtag.utils.noop;
        ...
        key: 'removePseudos',
        value: function removePseudos(target, pseudos) {
...
var Repository = function Repository() {
    _classCallCheck$7(this, Repository);
...
var Clone = function () {
    function Clone() {
        _classCallCheck$9(this, Clone);
    }

    _createClass$8(Clone, null, [{
        key: "object",
        value: function object(src, utils) {
            var obj = {};
            for (var key in src) {
        ...
        key: "array",
        value: function array(src, utils) {
            var i = src.length;
...
var Utilities = function () {
    function Utilities(xtag) {
        _classCallCheck$8(this, Utilities);
    ...
    _createClass$7(Utilities, [{
        key: 'noop',
        value: function noop() {}
    }, {
        key: 'trueop',
        value: function trueop() {
            return true;
        }
    }, {
        key: 'typeOf',
        value: function typeOf(obj) {
            var type = this.typeString.call(obj);
            return this.typeCache[type] || (this.typeCache[type] = type.match(this.typeRegexp)[1].toLowerCase());
        }
    }, {
        key: 'clone',
        value: function clone(item, type) {
            var fn = Clone[(type || this.typeOf(item), this)];
        ...
        */
        ...
        key: 'merge',
        value: function merge(source, k, v) {
            var argLength = arguments.length;
            if (this.typeOf(k) == 'string') {
                return this.mergeOne(source, k, v);
            }
            for (var i = 1, l = argLength; i < l; i++) {
                ...
                if (object instanceof this.xtag.constructor) {
                    ...
                    for (var _key in object) {
                        this.mergeOne(source, _key, object[_key]);
                    }
                }
            }
            return source;
        ...
        key: 'mergeOne',
        value: function mergeOne(source, key, current) {
...
var XTag = function () {
    ...
    _createClass$1(XTag, [{
        ...
        key: '_register',
        value: function _register(name, options) {
            var _name,
                curTag = this;
            ...
            proto.setAttribute = {
                ...
                value: function value(name, _value) {
                    ...
                    curTag.accessors.modAttr(this, attr, _name, _value, 'setAttribute');
                    if (attr) {
                        if (attr.setter) attr.setter.call(this, attr.boolean ? true : _value, old);
                        curTag.accessors.syncAttr(this, attr, _name, _value, 'setAttribute');
                    }
                }
            };
            ...
            if (basePrototype) Object.getOwnPropertyNames(basePrototype).forEach(function (z) {
                ...
                if (prop) {
                    for (var y in desc) {
                        if (typeof desc[y] == 'function' && prop[y]) prop[y] = curTag.utils.wrap(desc[y], prop[y]);else prop[y] = desc[y];
                    }
                }
                proto[z] = prop || desc;
            });

            definition['prototype'] = Object.create(extended ? Object.create(document.createElement(extended).constructor).prototype : window.HTMLElement.prototype, proto);
...
var Child = function (_XTag) {
    ...
    _createClass(Child, [{
        ...
        get: function get() {
            return {
                tap: function tap() {
                    if (this.xtagObj.interval) this.stop();else this.start();
                }
            };
        }
    }]);
